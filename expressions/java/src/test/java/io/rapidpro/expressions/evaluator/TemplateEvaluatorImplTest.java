...
public class TemplateEvaluatorImplTest {
    ...
    public void evaluateExpression() {
        ...
        assertThat(m_evaluator.evaluateExpression("4 / 2", new EvaluationContext()), is(new BigDecimal("2.0000000000")));
        ...
        // check precedence
        assertThat(m_evaluator.evaluateExpression("2 + 3 / 4 - 5 * 6", new EvaluationContext()), is(new BigDecimal("-27.2500000000")));
