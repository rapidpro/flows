...
public class RunnerImplTest {
    ...
    public void startAndResume() throws Exception {
        ...
        assertThat(state1.getSteps().get(0).getActions(), hasSize(1));
        assertReply(state1.getSteps().get(0).getActions(), 0, "Hi Joe. Do you like mushrooms?");
        ...
        assertThat(state2.getSteps().get(1).getActions(), hasSize(1));
        assertReply(state2.getSteps().get(1).getActions(), 0, "We didn't understand your answer. Please reply with yes/no.");
        ...
        assertThat(state3.getSteps().get(1).getActions(), hasSize(2));
        assertReply(state3.getSteps().get(1).getActions(), 0, "That was the right answer.");
        assertAddToGroup(state3.getSteps().get(1).getActions(), 1, "Approved");
    }
